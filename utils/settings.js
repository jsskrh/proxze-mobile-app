...
const settings = {
  states: [
    {
      ...
      lgas: [
        ...
        { location: "Eti-Osa East", multiple: "High" },
        { location: "Eti-Osa West", multiple: "High" },
        ...
        { location: "Lagos Island West", multiple: "High" },
        { location: "Lagos Island East", multiple: "High" },
  ...
  //     locationState: "Lagos",
  //     lgas: [
  //       { location: "Agege", multiple: locationClass.low },
  //       { location: "Orile-Agege", multiple: locationClass.low },
  //       { location: "Ajeromi", multiple: locationClass.low },
  //       { location: "Ifelodun", multiple: locationClass.low },
  //       { location: "Alimosho", multiple: locationClass.mid },
  //       { location: "Agbado/Oke-Odo", multiple: locationClass.high },
  //       { location: "Ayobo-Ipaja", multiple: locationClass.mid },
  //       { location: "Egbe-Idimu", multiple: locationClass.mid },
  //       { location: "Igando-Ikotun", multiple: locationClass.low },
  //       { location: "Mosan Okunola", multiple: locationClass.low },
  //       { location: "Amuwo-Odofin", multiple: locationClass.mid },
  //       { location: "Oriade", multiple: locationClass.low },
  //       { location: "Apapa", multiple: locationClass.high },
  //       { location: "AgeApapa Iganmu", multiple: locationClass.low },
  //       { location: "Badagry", multiple: locationClass.low },
  //       { location: "Badagry West", multiple: locationClass.low },
  //       { location: "Olorunda", multiple: locationClass.low },
  //       { location: "Epe", multiple: locationClass.mid },
  //       { location: "Eredo", multiple: locationClass.low },
  //       { location: "Ikosi Ejinrin", multiple: locationClass.mid },
  //       { location: "Eti-Osa East", multiple: locationClass.high },
  //       { location: "Eti-Osa West", multiple: locationClass.high },
  //       { location: "Iru Victoria Island", multiple: locationClass.high },
  //       { location: "Ikoyi-Obalende", multiple: locationClass.high },
  //       { location: "Ibeju", multiple: locationClass.high },
  //       { location: "Lekki", multiple: locationClass.high },
  //       { location: "Ifako/Ijaiye", multiple: locationClass.mid },
  //       { location: "Ojokoro", multiple: locationClass.low },
  //       { location: "Ikeja", multiple: locationClass.high },
  //       { location: "Ojodu", multiple: locationClass.mid },
  //       { location: "Onigbongbo", multiple: locationClass.low },
  //       { location: "Ikorodu", multiple: locationClass.low },
  //       { location: "Ikorodu North", multiple: locationClass.low },
  //       { location: "Ikorodu West", multiple: locationClass.low },
  //       { location: "Imota", multiple: locationClass.low },
  //       { location: "Ijede", multiple: locationClass.low },
  //       { location: "Igbogbo-Baiyeku", multiple: locationClass.low },
  //       { location: "Kosofe", multiple: locationClass.mid },
  //       { location: "Ikosi Isheri", multiple: locationClass.mid },
  //       { location: "Agboyi-Ketu", multiple: locationClass.low },
  //       { location: "Lagos Island West", multiple: locationClass.high },
  //       { location: "Lagos Island East", multiple: locationClass.high },
  //       { location: "Lagos Mainland", multiple: locationClass.mid },
  //       { location: "Yaba", multiple: locationClass.mid },
  //       { location: "Mushin", multiple: locationClass.low },
  //       { location: "Odi-Olowo", multiple: locationClass.low },
  //       { location: "Ojo", multiple: locationClass.low },
  //       { location: "Oto Awori", multiple: locationClass.low },
  //       { location: "Iba", multiple: locationClass.low },
  //       { location: "Shomolu", multiple: locationClass.mid },
  //       { location: "Bariga", multiple: locationClass.low },
  //       { location: "Ejigbo", multiple: locationClass.low },
  //       { location: "Isolo", multiple: locationClass.low },
  //       { location: "Oshodi", multiple: locationClass.low },
  //       { location: "Surulere", multiple: locationClass.high },
  //       { location: "Coker Aguda", multiple: locationClass.low },
  //       { location: "Itire-Ikate", multiple: locationClass.low },
  //     ],
  //   },
  //   { locationState: "Abuja", lgas: [] },
  //   { locationState: "Port Harcourt", lgas: [] },
  //   { locationState: "Enugu", lgas: [] },
  //   { locationState: "Cross River", lgas: [] },
  //   { locationState: "Kano", lgas: [] },
  // ],

  // locationClass: [{ high: 2 }, { mid: 1.5 }, { low: 1 }],
